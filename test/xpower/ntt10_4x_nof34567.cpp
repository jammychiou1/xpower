...
typedef std::array<std::array<int16_t, 8>, 5> input;
...
bool run_testcase(inout testcase) {
  ...
  int16x8_t f8 = vld1q_s16(&testcase.first[3][0]);
  int16x8_t f9 = vld1q_s16(&testcase.first[4][0]);

  int16x8_t h0_4x, h1_4x, h2_4x, h3_4x, h4_4x, h5_4x, h6_4x, h7_4x, h8_4x, h9_4x;
  xpower::main_lay1::ntt10_4x_nof35467(
      f0, f1, f2, f8, f9,
...
int main() {
  std::array<int, 5> indices = {0, 1, 2, 8, 9};
  for (int idx : indices) {
