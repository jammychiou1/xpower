...
namespace xpower::main_lay1 {
  ...
  void fwd_extract(int16_t arr[10][2][9][8], const int16_t main_poly[768]) {
    for (int j = 0; j < 9; j++) {
      ...
      if (j <= 2) {
        int16x8x2_t f7 = vld1q_s16_x2(&main_poly[poly_base(j + 5, j)]);
        int16x8x2_t f8 = vld1q_s16_x2(&main_poly[poly_base(j + 6, j)]);
        int16x8x2_t f9 = vld1q_s16_x2(&main_poly[poly_base(j + 7, j)]);
        int16x8x2_t f0 = vld1q_s16_x2(&main_poly[poly_base(j + 8, j)]);
        int16x8x2_t f1 = vld1q_s16_x2(&main_poly[poly_base(j + 9, j)]);
        int16x8x2_t f2 = vld1q_s16_x2(&main_poly[poly_base(j + 10, j)]);

        for (int k0 = 0; k0 < 2; k0++) {
          ntt10_4x_nof3546(
              f0.val[k0], f1.val[k0], f2.val[k0], f7.val[k0], f8.val[k0], f9.val[k0],
              h0_4x, h1_4x, h2_4x, h3_4x, h4_4x,
              h5_4x, h6_4x, h7_4x, h8_4x, h9_4x);
          twist_his(
              h0_4x, h1_4x, h2_4x, h3_4x, h4_4x,
              h5_4x, h6_4x, h7_4x, h8_4x, h9_4x, j);
        ...
        for (int k0 = 0; k0 < 2; k0++) {
          ntt10_4x_nof35467(
              f0.val[k0], f1.val[k0], f2.val[k0], f8.val[k0], f9.val[k0],
              h0_4x, h1_4x, h2_4x, h3_4x, h4_4x,
              h5_4x, h6_4x, h7_4x, h8_4x, h9_4x);
          twist_his(
              h0_4x, h1_4x, h2_4x, h3_4x, h4_4x,
